...
(function () {
  ...
  function initSidebarNavigation() {
    ...
    var items = [
      { type: "link", href: prefix + "admins.html", title: "Admins", icon: "bi-people" },
      {
        type: "dropdown",
        title: "Home",
        icon: "bi-house-door",
        links: [
          { href: prefix + "slider.html", label: "Slider", icon: "bi-sliders" },
          { href: prefix + "department-news.html", label: "News", icon: "bi-newspaper" },
        ],
      },
      { type: "link", href: prefix + "overview.html", title: "Overview", icon: "bi-grid-1x2" },
      {
        type: "dropdown",
        title: "Senior Staff",
        icon: "bi-person-badge",
        links: [
          { href: prefix + "senior-staff.html", label: "Senior Staff", icon: "bi-person-badge" },
          { href: prefix + "impact.html", label: "Impact", icon: "bi-bar-chart-line" },
        ],
      },
      {
        type: "dropdown",
        ...
        icon: "bi-hospital",
        links: [
          { href: prefix + "mci-plan.html", label: "MCI Plan", icon: "bi-journal-text" },
          { href: prefix + "registration.html", label: "Registration", icon: "bi-person-plus" },
          { href: prefix + "triage.html", label: "Triage", icon: "bi-clipboard2-pulse" },
        ],
      },
      {
        type: "dropdown",
        ...
        icon: "bi-heart-pulse",
        links: [
          { href: prefix + "ipc.html", label: "IPC", icon: "bi-shield" },
          { href: prefix + "monitoring.html", label: "Monitoring", icon: "bi-activity" },
          { href: prefix + "checking-stocking.html", label: "Checking and Stocking", icon: "bi-box-seam" },
          { href: prefix + "training.html", label: "Training", icon: "bi-mortarboard" },
        ],
      },
      {
        type: "dropdown",
        ...
        links: [
          { href: prefix + "gbv.html", label: "GBV", icon: "bi-shield-exclamation" },
          { href: prefix + "child-protection.html", label: "Child Protection", icon: "bi-people" },
        ],
      },
      {
        type: "dropdown",
        ...
        links: [
          { href: prefix + "privacy-policy.html", label: "Privacy Policy", icon: "bi-file-lock2" },
          { href: prefix + "terms-of-use.html", label: "Terms of Use", icon: "bi-file-text" },
          { href: prefix + "disclaimer.html", label: "Disclaimer", icon: "bi-exclamation-triangle" },
        ],
      },
      { type: "link", href: prefix + "uk-med.html", title: "UK-MED", icon: "bi-shield-check" },
      { type: "link", href: prefix + "ed-research.html", title: "ED Research", icon: "bi-graph-up-arrow" },
      {
        type: "dropdown",
        title: "Knowledge",
        icon: "bi-journal-medical",
        links: [
          { href: prefix + "knowledge-categories.html", label: "Categories", icon: "bi-diagram-3" },
          { href: prefix + "knowledge.html", label: "Protocols", icon: "bi-journal-text" },
        ],
      },
      { type: "link", href: prefix + "telemedicine.html", title: "Telemedicine", icon: "bi-camera-video" },
      { type: "link", href: prefix + "podcast.html", title: "Podcast", icon: "bi-mic" },
      { type: "link", href: prefix + "hand-over.html", title: "Hand Over", icon: "bi-box-arrow-right" },
      { type: "link", href: prefix + "settings.html", title: "Settings", icon: "bi-gear" },
    ];
    ...
    items.forEach(function (item) {
      if (item.type === "dropdown") {
        ...
        item.links.forEach(function (child) {
          ...
          html.push('<a class="nav-link-item nav-link-sub' + (isActive ? " active" : "") + '" href="' + esc(child.href) + '"><i class="bi ' + esc(child.icon) + '"></i> ' + esc(child.label) + "</a>");
        });
        html.push("</div></details>");
      } else {
        var isActive = isHrefActive(item.href);
        html.push('<a class="nav-link-item' + (isActive ? " active" : "") + '" href="' + esc(item.href) + '"><i class="bi ' + esc(item.icon) + '"></i> ' + esc(item.title) + "</a>");
      }
    });
